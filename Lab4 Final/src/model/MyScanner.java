...
public class MyScanner {
    ...
    private final FiniteAutomata finiteAutomataInteger;

    public MyScanner() throws FileNotFoundException {
        languageSpecification = new LanguageSpecification();
        finiteAutomataIdentifier = new FiniteAutomata("FA/fa_identifier.txt");
        finiteAutomataInteger = new FiniteAutomata("FA/fa_integer.txt");
        finiteAutomataInteger.readFromFile();
        finiteAutomataIdentifier.readFromFile();
    }
...
//        return token.matches(pattern);
        return finiteAutomataIdentifier.isAccepted(token);
    }
    ...
    public boolean isConstant(String token) {
        ...
        String pattern = "^'.'$|^\".*\"$|\\[[1-9]+[0-9]*, " +
                ...
                "|\\[[1-9]+[0-9]*]$|\\['[a-zA-Z]+']$";
        return token.matches(pattern) || finiteAutomataInteger.isAccepted(token);
    }
